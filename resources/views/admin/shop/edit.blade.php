...
@section('content')
    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <label>
                    <input type="radio" name="status"  @if($shop->status===1) checked @endif  value="1" >启用
                    <input type="radio" name="status"  @if($shop->status===-1) checked @endif value="0" >待审核
                    <input type="radio" name="status"  @if($shop->status===0) checked @endif value="-1" >禁用
                </label>
            </div>
        </div>
